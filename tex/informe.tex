...
\subsection{Comparación en distribución uniforme}
En el caso de la selectividad por igualdad, dado que el estimador ClassicHistogram asume distribución uniforme de los datos para calcular la estimación, debería presentar la mejor performance entre los distintos estimadores.


\subsection{Comparación en distribución normal}
